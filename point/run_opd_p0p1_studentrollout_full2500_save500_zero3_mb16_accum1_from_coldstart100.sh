...
COLDSTART_MODEL=/data/msz/models/opd_offpolicy_coldstart100_p0p1_fullvocab_maxnew128_prefix64_veto1to0_zero3_mb16_accum1_20260527_132800
RUN_NAME="opd_p0p1_studentrollout_full2500_save500_zero3_mb16_accum1_from_coldstart100_maxnew64_prefix64_veto1to0s500_maxnorm5_$(date +%Y%m%d_%H%M%S)"
...
: > "${PEAK_LOG}"
echo "${OUT}" > /data/msz/point/latest_opd_p0p1_full2500_from_coldstart_output.txt
echo "${LOG}" > /data/msz/point/latest_opd_p0p1_full2500_from_coldstart_log.txt
