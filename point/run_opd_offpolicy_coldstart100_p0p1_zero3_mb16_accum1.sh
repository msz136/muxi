...
RUN_NAME="opd_offpolicy_coldstart100_p0p1_fullvocab_maxnew128_prefix64_veto1to0_zero3_mb16_accum1_$(date +%Y%m%d_%H%M%S)"
...
: > "${PEAK_LOG}"
echo "${OUT}" > /data/msz/point/latest_opd_offpolicy_coldstart100_p0p1_output.txt
echo "${LOG}" > /data/msz/point/latest_opd_offpolicy_coldstart100_p0p1_log.txt
